class Renderer {
  ...
  async renderWeather(data) {
    ...
    const daydata1 = new Date(data.days[0].datetime).toLocaleDateString(
      'en-US',
      { weekday: 'long' }
    );
    info1.innerHTML = `
    ...
    const daydata2 = new Date(data.days[1].datetime).toLocaleDateString(
      'en-US',
      { weekday: 'long' }
    );
    info2.innerHTML = `
    ...
    const daydata3 = new Date(data.days[3].datetime).toLocaleDateString(
      'en-US',
      { weekday: 'long' }
    );
    info3.innerHTML = `
    ...
    const daydata4 = new Date(data.days[4].datetime).toLocaleDateString(
      'en-US',
      { weekday: 'long' }
    );
    info4.innerHTML = `
    ...
    const daydata5 = new Date(data.days[5].datetime).toLocaleDateString(
      'en-US',
      { weekday: 'long' }
    );
    info5.innerHTML = `
